...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=200&section=header&text=Ikhwan%20Maulana&fontSize=50&fontColor=ffffff&animation=fadeIn&desc=AI%20Engineer%20%7C%20Machine%20Learning%20%7C%20Computer%20Vision&descAlignY=60&descSize=18" width="100%"/>

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&pause=1000&color=2EA043&center=true&vCenter=true&width=600&lines=Building+End-to-End+AI+Solutions;Computer+Vision+%7C+Deep+Learning+%7C+YOLO;Turning+Data+into+Real-World+Impact;Always+Learning%2C+Always+Building" alt="Typing SVG" />
...
<img src="https://komarev.com/ghpvc/?username=IkhwanMaulana07&label=Profile%20Views&color=2EA043&style=for-the-badge" alt="profile views" />
...
```yaml
name: Ikhwan Maulana
role: AI Engineer | Machine Learning | Computer Vision
location: Bekasi, Indonesia
education: "B.Sc Informatics Engineering, Universitas Gunadarma (GPA 3.78/4.00, Class of 2026)"
focus: ["Deep Learning", "Computer Vision", "Generative AI", "MLOps"]
currently_learning: ["Generative AI", "Cloud & Mobile AI Deployment", "NLP"]
fun_fact: "Turned Black Soldier Fly larvae into a full computer vision pipeline 🐝"
```

- 🔭 Experienced in building **end-to-end AI solutions**: data preprocessing → model training → evaluation → deployment
- 🧠 Domain expertise in **object detection, image classification, recommendation systems, regression modeling**
- 🐝 Bachelor's thesis: **BSF Larva Growth Stage Detection** (YOLOv11s → TensorFlow Lite → Flutter)
